    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="电影类型" prop="dianyingleixing">
          <el-input v-model="temp.dianyingleixing" />
        </el-form-item>
...
export default {
  ...
  methods: {
    getList() {
      ...
      axios.get('movietype/mt', { params: this.listQuery }).then((res) => {
        // console.log(res);
    ...
    updateinfo() {
      this.$refs['dataForm'].validate((valid) => {
        ...
        if (valid) {
          axios.post('movietype/updatemt', tempData).then((res) => {
            // console.log(res);
    ...
    handleDelete(row, index) {
      ...
      axios.post('movietype/del', JSON.stringify(row.id)).then((res) => {
        // console.log(res);
        this.$notify({
          title: 'Success',
          message: '删除成功',
